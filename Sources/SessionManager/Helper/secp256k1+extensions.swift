...
extension secp256k1 {
    ...
    private static func unmarshalSignature(signatureData: Data) -> UnmarshaledSignature? {
    ...
    private static func marshalSignature(v: UInt8, r: [UInt8], s: [UInt8]) -> Data? {
    ...
    private static func marshalSignature(v: Data, r: Data, s: Data) -> Data? {
        guard r.count == 32, s.count == 32 else { return nil }
        var completeSignature = Data(r)
    ...
    // TODO: Translate below functions to secp256k1 objects and methods and not use library directly.
    
    static func sign(privkey: secp256k1.Signing.PrivateKey, messageData: String) throws -> Signature {
